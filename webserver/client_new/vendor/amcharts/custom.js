    ...
    AmCharts.ready(function () {
        ...
        function frmt(x) {
            ...
            var r = "<table>" +
                ...
                "</td></tr>" +
                '<tr><th>Bet:</th><td>' + (entry.bet/1).toFixed() + ' bnbs</td></tr>' +
                "<tr><th>Crash At:</th><td>" + (typeof entry.game_crash !== 'undefined' ? (entry.game_crash/100).toFixed(2) + 'x' : '?') + "</td></tr>" +
                "<tr><th>Cashed Out:</th><td>" + (entry.cash_out ? ((entry.cash_out/1+entry.bet*0.01) / entry.bet).toFixed(2) + 'x' : '-') + "</td></tr>" +
                "<tr><th>Profit:</th><td><b>" + (profit/1).toFixed(2) + " bnbs</b></td></tr>" +
                '</table>';
            return r;
