    ...
    return {
        ...
        parseBet: function (betString) {
            ...
            if (bet * 100 > AppConstants.Engine.MAX_BET)
                return new Error('The bet must be less no more than ' + formatSatoshis(AppConstants.Engine.MAX_BET) + ' bnbs');
        ...
        //Returns plural or singular, for a given amount of bnbs.
        grammarBnbs: function (bnbs) {
            return bnbs <= 100 ? 'bit' : 'bnbs';
        },
